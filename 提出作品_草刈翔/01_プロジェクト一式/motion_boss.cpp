...
// 初期化処理
//=============================================================================
HRESULT CMotionBoss::Init(CScene *pScene)
{
	FILE *pFile = NULL;
	CEnemy *pEnemy = NULL;
...
// 更新処理
//=============================================================================
void CMotionBoss::Update(CScene *pScene)
{
	CEnemy *pEnemy = NULL;
	pEnemy = (CEnemy*)pScene;
...
// 生成処理
//=============================================================================
CMotionBoss *CMotionBoss::Create(CScene *pScene)
{
	// クラスの生成
	CMotionBoss *pMotion = NULL;
	pMotion = new CMotionBoss;
