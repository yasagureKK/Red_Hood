...
// コンストラクタ
//=============================================================================
CMotionWolf00::CMotionWolf00(void)
{
...
// 初期化処理
//=============================================================================
HRESULT CMotionWolf00::Init(CScene *pScene)
{
	FILE *pFile = NULL;
	CEnemy *pEnemy = NULL;
...
// 終了処理
//=============================================================================
void CMotionWolf00::Uninit(void)
{
	delete this;
}
...
// 更新処理
//=============================================================================
void CMotionWolf00::Update(CScene *pScene)
{
	CEnemy *pEnemy = NULL;
	pEnemy = (CEnemy*)pScene;
...
// 生成処理
//=============================================================================
CMotionWolf00 *CMotionWolf00::Create(CScene *pScene)
{
	// クラスの生成
	CMotionWolf00 *pMotion = NULL;
	pMotion = new CMotionWolf00;
